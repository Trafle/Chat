...
!(function (global, setTimeout) {
  ...
  if (void 0 === define) {
    ...
    req({}),
    each(['toUrl', 'undef', 'defined', 'specified'], t => {
      req[t] = function () {
        const e = contexts[defContextName];
    ...
    (req.load = function (t, i, r) {
      ...
      if (isWebWorker)
        try {
          setTimeout(() => {}, 0), importScripts(r), t.completeLoad(i);
        } catch (e) {
          t.onError(
            makeError(
              'importscripts',
  ...
  function newContext(u) {
    ...
    function s(e) {
      const t = e.currentTarget || e.srcElement;
      return (
